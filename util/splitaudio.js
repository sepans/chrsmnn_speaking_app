...
const audioFile = audioPath + 'goon.mp3'
const audioEndTime = 4150.56 // 6047.736 for speaking 4150.56 for goon
const jsonFile = '../goon.json'
...
paragraphs.forEach((paragraph, i) => {
	...
	const ffmpegCommand = `ffmpeg -ss ${startTimeSeconds} -t ${endTimeSeconds} -i ${audioFile} ${audioPath}/goon_${i}.mp3`
